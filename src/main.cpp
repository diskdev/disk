...
const string strMessageMagic = "DarkLisk Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
	...
	else if(pindexBest->nHeight < 60001)
	{
        nSubsidy = 800 * COIN;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DarkLisk", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "DarkLisk is much greater than Lisk";
        CTransaction txNew;
        txNew.nTime = 1460138706;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
		...
		uint256 nhashMerkleRoot = uint256("0x3949d5535ff6e7c74ea9605a180ba679bb83ac6b0b99d4f5508c3d04e941fa9f");
...
unsigned char pchMessageStart[4] = { 0xb1, 0xa2, 0xc3, 0xd4 };
